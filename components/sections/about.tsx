...
export function About() {
  return (
    <Section
      ...
      className="nocturne-panel flex min-h-[100svh] flex-col overflow-hidden border-b border-gold-lo/30 px-5 pb-7 pt-20 sm:px-10 sm:pb-10 sm:pt-24 lg:px-[6vw] lg:py-[10vh]"
    >
      <div className="mx-auto flex w-full max-w-7xl flex-1 flex-col justify-center gap-5 lg:relative lg:block">
